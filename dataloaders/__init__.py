...
def make_data_loader(args, **kwargs):
    ...
    if args.dataset == 'oled_data':
        ...
        if args.ddp :
            ...
            train_loader = DataLoader(train_set, batch_size=args.batch, shuffle=False, drop_last=True,
                sampler=train_sampler, **kwargs)

            val_loader   = DataLoader(val_set, batch_size=args.batch, shuffle=False, drop_last=True,
                sampler=val_sampler, **kwargs)

        else :
            train_loader = DataLoader(train_set, batch_size=args.batch, shuffle=True, **kwargs)
            val_loader   = DataLoader(val_set, batch_size=args.batch, shuffle=False, **kwargs)
